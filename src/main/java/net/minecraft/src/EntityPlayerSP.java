...
public class EntityPlayerSP extends EntityPlayer
{
     ...
     */
    public void setXPStats(float par1, int par2, int par3, int strength, int agility, int endurance, int accuracy) //EMBER
    {
        this.experience = par1;
        this.experienceTotal = par2;
        this.experienceLevel = par3;
		//EMBER START
		this.eStatStrength = strength;
		this.eStatAgility = agility;
		this.eStatEndurance = endurance;
		this.eStatAccuracy = accuracy;
		//EMBER END
    }
