...
public interface IBlockAccess
{
    ...
    int getLightBrightnessForSkyBlocksRed(int var1, int var2, int var3, int var4);
    int getLightBrightnessForSkyBlocksGreen(int var1, int var2, int var3, int var4);
    int getLightBrightnessForSkyBlocksBlue(int var1, int var2, int var3, int var4);

    float getBrightness(int var1, int var2, int var3, int var4);
    float getBrightnessRed(int var1, int var2, int var3, int var4);
    float getBrightnessGreen(int var1, int var2, int var3, int var4);
    float getBrightnessBlue(int var1, int var2, int var3, int var4);
