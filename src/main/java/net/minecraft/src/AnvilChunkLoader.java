...
public class AnvilChunkLoader implements IThreadedFileIO, IChunkLoader
{
    ...
    private void writeChunkToNBT(Chunk par1Chunk, World par2World, NBTTagCompound par3NBTTagCompound)
    {
        ...
        for (int var8 = 0; var8 < var7; ++var8)
        {
            ...
            if (var9 != null)
            {
                ...
                var10.setIntArray("BlockLightRed", var9.getRedBlocklightArray().data);
                var10.setIntArray("BlockLightGreen", var9.getGreenBlocklightArray().data);
                var10.setIntArray("BlockLightBlue", var9.getBlueBlocklightArray().data);
    ...
    private Chunk readChunkFromNBT(World par1World, NBTTagCompound par2NBTTagCompound)
    {
        ...
        for (int var9 = 0; var9 < var6.tagCount(); ++var9)
        {
            ...
            var12.setRedBlocklightArray(new IntArray(var10.getIntArray("BlockLightRed"), 4));
            var12.setGreenBlocklightArray(new IntArray(var10.getIntArray("BlockLightGreen"), 4));
            var12.setBlueBlocklightArray(new IntArray(var10.getIntArray("BlockLightBlue"), 4));
