...
public class StringTranslate
{
    ...
    private void loadLanguageList()
    {
        ...
        try
        {
            BufferedReader var2 = new BufferedReader(new InputStreamReader(StringTranslate.class.getResourceAsStream("/xlang/languages.txt"), "UTF-8"));
    ...
    {
        BufferedReader var3 = new BufferedReader(new InputStreamReader(StringTranslate.class.getResourceAsStream("/xlang/" + par2Str + ".lang"), "UTF-8"));
