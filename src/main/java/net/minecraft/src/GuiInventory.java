...
public class GuiInventory extends InventoryEffectRenderer
{
	...
	private EntityPlayer activePlayer;//EMBER
    ...
    public GuiInventory(EntityPlayer par1EntityPlayer)
    {
		...
		this.activePlayer = par1EntityPlayer;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
		...
		int baseX = (this.width / 4) * 3;
		int baseY = this.height / 4;
		int lineHeight = 12;
		int columnWidth = 60;
		this.drawString(this.fontRenderer, "Strength:", baseX, baseY, 16777215);
		this.drawString(this.fontRenderer, String.valueOf(this.activePlayer.eStatStrength), baseX + columnWidth, baseY, 16777215);
		this.drawString(this.fontRenderer, "Accuracy:", baseX, baseY + lineHeight, 16777215);
		this.drawString(this.fontRenderer, String.valueOf(this.activePlayer.eStatAccuracy), baseX + columnWidth, baseY + lineHeight, 16777215);
		this.drawString(this.fontRenderer, "Agility:", baseX, baseY + (lineHeight*2), 16777215);
		this.drawString(this.fontRenderer, String.valueOf(this.activePlayer.eStatAgility), baseX + columnWidth, baseY + (lineHeight*2), 16777215);
		this.drawString(this.fontRenderer, "Endurance:", baseX, baseY + (lineHeight*3), 16777215);
		this.drawString(this.fontRenderer, String.valueOf(this.activePlayer.eStatEndurance), baseX + columnWidth, baseY + (lineHeight*3), 16777215);
		//EMBER END
    }
