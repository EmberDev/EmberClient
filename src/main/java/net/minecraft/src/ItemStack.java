...
public final class ItemStack
{
        ...
        if (this.hasTagCompound())
        {
			...
			if(this.getItem().isItemTool(this)){
				...
				if(toolStats != null){
					...
					var3.add("Sharpness: " + toolStats.getShort("sharpness"));
					var3.add("Mobility: " + toolStats.getShort("mobility"));
					var3.add("Speed: " + toolStats.getShort("speed"));
					var3.add("Impact: " + toolStats.getShort("impact"));
					var3.add("Critical: " + toolStats.getShort("critical"));
					var3.add("Expertise Rating: " + toolStats.getShort("expertise"));
				}
			}
			//EMBER END
    ...
    /**
     * Adds tool stats to an itemstack
     */
    public void addToolStats(short hardness, short sharpness, short mobility, short speed, short impact, short critical, short expertise)
    {
        if (this.stackTagCompound == null)
        {
        ...
        if (!this.stackTagCompound.hasKey("tstats"))
        {
            this.stackTagCompound.setTag("tstats", new NBTTagCompound("tstats"));
        }

        NBTTagCompound var4 = this.stackTagCompound.getCompoundTag("tstats");
        var4.setShort("hardness", hardness);
        var4.setShort("mobility", mobility);
        var4.setShort("speed", speed);
        var4.setShort("impact", impact);
        var4.setShort("critical", critical);
        var4.setShort("sharpness", sharpness);
        var4.setShort("expertise", expertise);
    }
	//EMBER END
    /**
