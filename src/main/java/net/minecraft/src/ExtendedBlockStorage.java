...
public class ExtendedBlockStorage
{
    ...
    /** The IntArrays containing blocks of Block-light data. */
    private IntArray blocklightArrayRed;
    private IntArray blocklightArrayGreen;
    private IntArray blocklightArrayBlue;
    ...
    public ExtendedBlockStorage(int par1)
    {
        ...
        this.blocklightArrayRed = new IntArray(this.blockLSBArray.length, 4);
        this.blocklightArrayGreen = new IntArray(this.blockLSBArray.length, 4);
        this.blocklightArrayBlue = new IntArray(this.blockLSBArray.length, 4);
    }
    ...
    /**
     * Sets the saved RGB Block-light value in the extended block storage structure.
     */
    public void setExtRGBBlocklightValue(int x, int y, int z, int red, int green, int blue)
    {
        this.blocklightArrayRed.set(x, y, z, red);
        this.blocklightArrayGreen.set(x, y, z, green);
        this.blocklightArrayBlue.set(x, y, z, blue);
    }

    /**
     * Sets the saved Red Block-light value in the extended block storage structure.
     */
    public void setExtRGBBlocklightValueRed(int x, int y, int z, int value)
    {
        this.blocklightArrayRed.set(x, y, z, value);
    }

    /**
     * Sets the saved Green Block-light value in the extended block storage structure.
     */
    public void setExtRGBBlocklightValueGreen(int x, int y, int z, int value)
    {
        this.blocklightArrayGreen.set(x, y, z, value);
    }

    /**
     * Sets the saved Blue Block-light value in the extended block storage structure.
     */
    public void setExtRGBBlocklightValueBlue(int x, int y, int z, int value)
    {
        this.blocklightArrayBlue.set(x, y, z, value);
    }

    /**
     * Gets the saved Red Block-light value in the extended block storage structure.
     */
    public int getExtRGBBlocklightValueRed(int x, int y, int z)
    {
        return this.blocklightArrayRed.get(x, y, z);
    }

    /**
     * Gets the saved Green Block-light value in the extended block storage structure.
     */
    public int getExtRGBBlocklightValueGreen(int x, int y, int z)
    {
        return this.blocklightArrayGreen.get(x, y, z);
    }

    /**
     * Gets the saved Blue Block-light value in the extended block storage structure.
     */
    public int getExtRGBBlocklightValueBlue(int x, int y, int z)
    {
        return this.blocklightArrayBlue.get(x, y, z);
    }
    ...
    /**
     * Returns the IntArray instance containing Red Block-light data.
     */
    public IntArray getRedBlocklightArray()
    {
        return this.blocklightArrayRed;
    }

    /**
     * Returns the IntArray instance containing Green Block-light data.
     */
    public IntArray getGreenBlocklightArray()
    {
        return this.blocklightArrayGreen;
    }

    /**
     * Returns the IntArray instance containing Blue Block-light data.
     */
    public IntArray getBlueBlocklightArray()
    {
        return this.blocklightArrayBlue;
    }
    ...
    /**
     * Sets the IntArray instance used for Red Block-light values in this particular storage block.
     */
    public void setRedBlocklightArray(IntArray array)
    {
        this.blocklightArrayRed = array;
    }

    /**
     * Sets the IntArray instance used for Green Block-light values in this particular storage block.
     */
    public void setGreenBlocklightArray(IntArray array)
    {
        this.blocklightArrayGreen = array;
    }

    /**
     * Sets the IntArray instance used for Blue Block-light values in this particular storage block.
     */
    public void setBlueBlocklightArray(IntArray array)
    {
        this.blocklightArrayBlue = array;
    }
