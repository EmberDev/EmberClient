...
public class Packet43Experience extends Packet
{
    ...
    public Packet43Experience(float par1, int par2, int par3, int strength, int agility, int endurance, int accuracy) //EMBER - added stats
    {
    ...
    public void readPacketData(DataInputStream par1DataInputStream) throws IOException
    {
		...
		//EMBER START
		this.estr = par1DataInputStream.readShort();
		this.eagi = par1DataInputStream.readShort();
		this.eend = par1DataInputStream.readShort();
		this.eacc = par1DataInputStream.readShort();
		//EMBER END
    }
    ...
    public void writePacketData(DataOutputStream par1DataOutputStream) throws IOException
    {
		...
		//EMBER START
        par1DataOutputStream.writeShort(this.estr);
        par1DataOutputStream.writeShort(this.eagi);
        par1DataOutputStream.writeShort(this.eend);
        par1DataOutputStream.writeShort(this.eacc);
		//EMBER END
    }
    ...
    {
        return 8; //EMBER - changed 4 to 8 to accomodate the additional data
    }
