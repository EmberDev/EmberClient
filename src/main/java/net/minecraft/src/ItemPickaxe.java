...
public class ItemPickaxe extends ItemTool
{
    ...
    {
        return par2Block != null && (par2Block.blockMaterial == Material.iron || par2Block.blockMaterial == Material.anvil || par2Block.blockMaterial == Material.rock) ? super.getStrVsGoodBlock(par1ItemStack) : super.getStrVsBlock(par1ItemStack, par2Block); //EMBER
    }
}
