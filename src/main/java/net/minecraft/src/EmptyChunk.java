...
public class EmptyChunk extends Chunk
{
    ...
    public int getBlockLightValueRed(int par1, int par2, int par3, int par4)
    {
        return 0;
    }
    public int getBlockLightValueGreen(int par1, int par2, int par3, int par4)
    {
        return 0;
    }
    public int getBlockLightValueBlue(int par1, int par2, int par3, int par4)
    {
        return 0;
    }
