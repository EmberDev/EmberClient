...
public abstract class ServerConfigurationManager
{
    ...
    public EntityPlayerMP respawnPlayer(EntityPlayerMP par1EntityPlayerMP, int par2, boolean par3)
    {
        ...
        var7.playerNetServerHandler.sendPacketToPlayer(new Packet43Experience(var7.experience, var7.experienceTotal, var7.experienceLevel, var7.eStatStrength, var7.eStatAgility, var7.eStatEndurance, var7.eStatAccuracy)); //EMBER
