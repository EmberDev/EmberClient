            ...
            for (var8 = par4; var8 < par4 + var6 && var8 < 128; ++var8)
            {
                for (var9 = par3 - var7; var9 <= par3 + var7; ++var9)
                {
                    for (var10 = par5 - var7; var10 <= par5 + var7; ++var10)
                    {
                        ...
                        {
                            //EMBER START
							if(par2Random.nextInt(101) < 10) par1World.setBlockAndMetadataWithNotify(var9, var8, var10, Block.dragonstone.blockID, 1);
							else par1World.setBlockWithNotify(var9, var8, var10, Block.dragonstone.blockID);
							//EMBER END
                        }
                    }
                }
