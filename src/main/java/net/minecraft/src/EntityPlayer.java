...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender
{
	...
	//EMBER START
	public int eStatStrength = 1;
	public int eStatAccuracy = 1;
	public int eStatAgility = 1;
	public int eStatEndurance = 1;
	//EMBER END
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        ...
        {
            //this.inventory.dropAllItems(); //EMBER - disabled because we keep inventory
        }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
		...
		//EMBER START
		this.eStatStrength = par1NBTTagCompound.getInteger("EmberStrength");
		this.eStatAccuracy = par1NBTTagCompound.getInteger("EmberAccuracy");
		this.eStatAgility = par1NBTTagCompound.getInteger("EmberAgility");
		this.eStatEndurance = par1NBTTagCompound.getInteger("EmberEndurance");
		//EMBER END
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
		...
		//EMBER START
		par1NBTTagCompound.setInteger("EmberStrength", this.eStatStrength);
		par1NBTTagCompound.setInteger("EmberAccuracy", this.eStatAccuracy);
		par1NBTTagCompound.setInteger("EmberAgility", this.eStatAgility);
		par1NBTTagCompound.setInteger("EmberEndurance", this.eStatEndurance);
		//EMBER END
    ...
    {
		//EMBER START
		//comment all this crap and return 0 as we always keep our inventory/level
		/*
        if (this.worldObj.getGameRules().getGameRuleBooleanValue("keepInventory"))
        {
            return 0;
    ...
    public void clonePlayer(EntityPlayer par1EntityPlayer, boolean par2)
    {
		...
		//EMBER START
		//note for args: par2 is "stillAlive", true if we beat the game rather than dying
        //we want to always keep items. commented and replaced the following line:
		...
		//EMBER START
		//always copy stats over
		this.eStatStrength = par1EntityPlayer.eStatStrength;
		this.eStatAgility = par1EntityPlayer.eStatAgility;
		this.eStatEndurance = par1EntityPlayer.eStatEndurance;
		this.eStatAccuracy = par1EntityPlayer.eStatAccuracy;
		//EMBER END
