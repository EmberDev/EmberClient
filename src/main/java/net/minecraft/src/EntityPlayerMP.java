...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public void onUpdateEntity()
    {
        ...
        if (this.experienceTotal != this.lastExperience)
        {
            ...
            this.playerNetServerHandler.sendPacketToPlayer(new Packet43Experience(this.experience, this.experienceTotal, this.experienceLevel, this.eStatStrength, this.eStatAgility, this.eStatEndurance, this.eStatAccuracy)); //EMBER
        }
    }
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        ...
        {
            //this.inventory.dropAllItems(); //EMBER - we keep our shit together when we die.
        }
    }
